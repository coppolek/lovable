...
const PreviewPanel = ({ code }: PreviewPanelProps) => {
  ...
  const createPreviewComponent = () => {
    try {
      // For demo purposes, we'll render some sample components based on code content
      if (code.includes('CustomButton')) {
        return (
